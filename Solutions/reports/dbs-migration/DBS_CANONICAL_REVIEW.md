...
- DBS copies under `C:\Users\JDuve\OneDrive\Desktop\SLOPS\ssffmvp\Omen`
...
## 3. Omen Files That Should Become Canonical In Omen

Recommended canonical Omen product-layer files:
...
Recommended rule: Omen product/brand doctrine should become canonical inside `ssffmvp\Omen`, while active app implementation docs and source-driven specs remain canonical in the app repo until workflow references are changed.

## 4. Omen Reference Copies That Should Not Replace Active App Files
...
Do not replace files under `frontend`, `client`, `src`, `sql`, `scripts`, `test`, package files, or deployment config from Omen DBS reference copies.
...
2. Which copied Omen docs should be promoted after splitting.
