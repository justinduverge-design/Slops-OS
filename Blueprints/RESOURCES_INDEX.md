...
**Authoritative:** `Blueprints/skills/SKILL_ROUTING.md` — 36 skills, **Status column first** (legend at top of file). Skill lifecycle: `Blueprints/skills/SLOPS_LIFECYCLE.md`. Skill template: `Blueprints/skills/_template/SKILL.md`.
