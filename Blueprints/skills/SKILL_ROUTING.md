...
| `slops-markdown-authoring` | Claude first, Codex if writing files | `Layer 0` | `active` | Create, route, prune, and validate SLOPS Markdown files across DBS — operating packages, decisions, reviews, specs, prompts, patterns, handoffs, and lightweight skills. |
