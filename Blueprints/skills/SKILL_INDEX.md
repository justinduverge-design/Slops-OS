# Redirect — SKILL_INDEX.md

This file has been superseded by `SKILL_ROUTING.md`.

## Update

`SKILL_INDEX.md` was the deterministic skill lookup map. It has been replaced by the more comprehensive `SKILL_ROUTING.md`, which includes:

- Skill lookup by name
- Agent-to-skill routing
- Tool permission rules
- DBS layer guidance
- Analytical vs. execution skill categories
- Shared workflows
