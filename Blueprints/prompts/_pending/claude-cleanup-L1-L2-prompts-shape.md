...
| `kickoff.md` | template | Single local Omen starter. Multi-fire. Supersedes the retired vendor-named `kickoff-backend-codex.md` and `kickoff-frontend-claude.md`, both archived under `Archive/authority-routing/`. |
