...
- Do not stop.
- Report it under “Missing DBS Files.”
- Continue with the files that exist.
...
- Do not deploy unless Justin explicitly approves it.
- Do not touch .env files, secrets, keys, tokens, cookies, credentials, DNS, SSL, Nginx, production config, or private files.
...
Do not edit code until after that summary.
