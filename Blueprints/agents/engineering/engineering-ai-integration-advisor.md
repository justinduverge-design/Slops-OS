...
**superseded 2026-09-12 — converted to the `slops-ai-integration-review` skill.** This wrapper is kept as provenance for how `slops-ai-integration-review` was derived. Do not activate it; invoke the skill.
