...
- **Codex prompt for Phase 1.13 discrete fixes drafted** at `slops-saloon/omen/Archive/superseded-docs/2026-09-12/codex-phase1-13-discrete-fixes.md` (archived 2026-09-12). Single-PR, scope-locked, `frontend/phase1-13-discrete-fixes` branch. Sequenced *after* the logo-suite-swap PR to avoid `Header.jsx` / `Landing.jsx` collisions.
