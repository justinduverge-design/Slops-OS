...
Direct, useful, slightly witty, confident-not-arrogant, opinionated-not-reckless, clean, modern, fantasy-aware.

**Avoid:** overpromising, fake guarantees, gambling-style language, corporate fluff, excessive hype, political commentary, cussing, inappropriate jokes.

## Workflow

1. Identify update / result / insight.
2. Decide post type.
3. Draft.
4. Check for accuracy + overpromising.
5. Make visually presentable.
6. Publish or save.
7. Archive.
8. Track performance.
9. Feed lessons back into future posts.
...
slops-saloon/
  Direction/
    marketing-strategy.md         ← this file
  Blueprints/
    workflows/
      feature-update-post-workflow.md
      omen-proof-workflow.md
    prompts/
      feature-update-post-prompt.md
      weekly-proof-post-prompt.md
  Solutions/
    marketing/
      feature-updates/
      weekly-proof/
...
Start small. One product update post per meaningful feature update. One weekly proof post during the fantasy season. One simple visual template for posts. One monthly performance review. Do not build a full marketing machine before the app is useful.
