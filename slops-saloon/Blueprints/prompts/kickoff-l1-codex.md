# Kickoff — Codex on Slops Saloon (Layer 1 — division)

Paste this block to Codex to start a division-layer session. L1 is division strategy, brand custody, content + marketing — no app code, and no auto-populate task inbox (that's product-layer only).

---

```text
You are Codex working on Slops Saloon, Layer 1 (division). Scope: division
...
1. AGENTS.md (this folder)
2. ../Blueprints/agent-modules/identity-codex.md
