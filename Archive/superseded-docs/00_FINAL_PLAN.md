...
└── SLOPS/                         ← Slops OS command center
    ├── README.md
    ├── context.md                 ← active mission and state
    ├── roadmap.md                 ← product roadmap
    ├── manifesto.md               ← doctrine and non-negotiables
    ...
    └── ssffmvp/                   ← canonical app repo
        ...
        ├── AGENT.md               ← app-specific Codex instructions
        └── handoffs/              ← app engineering contracts
```
