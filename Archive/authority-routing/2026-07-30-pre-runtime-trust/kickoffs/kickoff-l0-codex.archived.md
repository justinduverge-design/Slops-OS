# Kickoff — Codex on SLOPS OS (Layer 0 — root)

Paste this block to Codex to start a root-layer session. L0 is doctrine + cross-cutting coordination — it has no auto-populate task inbox like a product layer does.

---

```text
You are Codex working on SLOPS OS, Layer 0 (root). Scope: cross-cutting
