...
| Intended-vs-implemented review | [`pm-ai-shipping`](https://github.com/phuryn/pm-skills/blob/main/pm-ai-shipping/README.md) | 18/25 | Reference method for review/DoD | **Harvest method only.** Full plugin overlaps `slops-code-review`, `slops-quality-baseline`, Codex Security, and Omen Done gates. |
